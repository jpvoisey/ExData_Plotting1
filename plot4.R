...
#Setup Graphics Device to have 2x2 layout
par(mfrow = c(2, 2))

#Plot Line Graph of Global Active Power
with(house_pow_cons,plot(DateTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))

#Plot Line Graph of Voltage 
with(house_pow_cons,plot(DateTime, Voltage, type = "l"))
...
legend(legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lwd = 1, x = "topright", bty = "n")

#Plot Line Graph of Global_reactive_power
with(house_pow_cons,plot(DateTime, Global_reactive_power, type = "l", lwd = 0.25))
